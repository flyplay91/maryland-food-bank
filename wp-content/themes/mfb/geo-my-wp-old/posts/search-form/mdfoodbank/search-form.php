 ...
 */
?>
<div id="gmw-pt-form-wrapper-<?php echo $gmw['form_id']; ?>" class="gmw-form-wrapper gmw-pt-form-wrapper gmw-pt-form-wrapper-<?php echo $gmw['form_id']; ?>">
	<form id="gmw-pt-form-<?php echo $gmw['form_id']; ?>" class="standard-form gmw-pt-form gmw-form" name="wppl_form" action="<?php echo $gmw['results_page']; ?>" method="get">
