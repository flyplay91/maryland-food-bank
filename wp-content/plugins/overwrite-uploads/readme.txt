...
After activating the plugin, you won't need to do anything else, it'll start working automatically. If you run into problems, please check the FAQ before opening a support request.
